...
for tt = 1:nTrials
    ...
    % Update the plot
    if nonBaselineTrials > 1 && showPlots
        ...
        % TTF figure
        subplot(2,1,2)
        scatter(stim(nonBaselineTrials),scaledBOLDresponse(nonBaselineTrials),'o','MarkerFaceColor','b','MarkerEdgeColor','none','MarkerFaceAlpha',.2)
